[![Stars](https://img.shields.io/github/stars/lzrdblzzrd/multi-proxy-config-fetcher?style=flat-square)](https://github.com/lzrdblzzrd/multi-proxy-config-fetcher/stargazers)
[![Forks](https://img.shields.io/github/forks/lzrdblzzrd/multi-proxy-config-fetcher?style=flat-square)](https://github.com/lzrdblzzrd/multi-proxy-config-fetcher/network/members)
[![Issues](https://img.shields.io/github/issues/lzrdblzzrd/multi-proxy-config-fetcher?style=flat-square)](https://github.com/lzrdblzzrd/multi-proxy-config-fetcher/issues)
[![License](https://img.shields.io/github/license/lzrdblzzrd/multi-proxy-config-fetcher?style=flat-square)](https://github.com/lzrdblzzrd/multi-proxy-config-fetcher/blob/main/LICENSE)
[![Activity](https://img.shields.io/github/last-commit/lzrdblzzrd/multi-proxy-config-fetcher?style=flat-square)](https://github.com/lzrdblzzrd/multi-proxy-config-fetcher/commits)
...
```
https://raw.githubusercontent.com/lzrdblzzrd/multi-proxy-config-fetcher/refs/heads/main/configs/proxy_configs.txt
```
...
```
https://raw.githubusercontent.com/lzrdblzzrd/multi-proxy-config-fetcher/refs/heads/main/configs/singbox_configs.json
```
...
### Подробный отчет
📊 [Просмотр полной интерактивной панели](https://htmlpreview.github.io/?https://github.com/lzrdblzzrd/multi-proxy-config-fetcher/blob/main/assets/performance_report.html)
...
git clone https://github.com/lzrdblzzrd/multi-proxy-config-fetcher.git
